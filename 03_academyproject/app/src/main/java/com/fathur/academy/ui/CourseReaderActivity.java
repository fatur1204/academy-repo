...
import com.fathur.academy.ui.reader.content.ModuleContentFragment;
import com.fathur.academy.ui.reader.list.ModuleListFragment;
...
public class CourseReaderActivity extends AppCompatActivity implements CourseReaderCallback {
    ...
    private static final String TAG = CourseReaderActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d(TAG, "List Materi : " + bundle);
        if (bundle != null) {
            String courseId = bundle.getString(EXTRA_COURSE_ID);
            Log.d(TAG, "detail Materi : " + courseId);
            if (courseId != null) {
